        ...
        <form class="form-inline" action="<%=context %>/servlet/PosteditServlet?action=add" method="post"
            ...
            <div id="operate" class="col-md-2 col-xs-12">
                ...
                <div class="publish">
                    ...
                    <h4>发布时间：</h4>
                    <input type="text" name="year" value="2018" size="4" maxlength="4" style="margin: 5px 0;">
                    - <input type="text" name="month" value="04" size="2" maxlength="2" style="margin: 5px 0;">
                    - <input type="text" name="day" value="24" size="2" maxlength="2" style="margin: 5px 0;"><br/>
                    @ <input type="text" name="hour" value="03" size="2" maxlength="2" autocomplete="off">
                    ： <input type="text" name="minute" value="13" size="2" maxlength="2" autocomplete="off"><br/>
                </div>
                <h4>摘要：</h4>
