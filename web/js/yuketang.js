...
// setTimeout(function(){ console.log("sleep2") }, 2000);
// window.history.go(-1);


var jb={"美的":{"美的":49,"三星":35,"海信":25,"格力":16,"方太":14},"三星":35,"海信":25,"格力":16,"方太":14};
if(jb["美的"]["美的"].equal(49)){
    console.log(1);
}
...
for(var i = 0;i <10;i++){
    var vedio_address = "https://www.yuketang.cn/v2/web/xcloud/video-student/8233437/" + i;
    setInterval(function(){
        window.location.href = "https://www.yuketang.cn/v2/web/studentLog/8233437";
        console.log(vedio_address);
    }, 10000);
}